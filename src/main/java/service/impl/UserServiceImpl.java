...
public class UserServiceImpl implements UserService {
    ...
    public int updateUser(String userType, Map<String, Object> map, String condition) {
        if (STUDENT.equals(userType)) {
            ...
            studentDao.updateColByOneCondition(ArrayUtil.mapToUpdateArr(ReflectUtil.getObjectFieldMap(new Student()), map, condition));
            return Response.OK;
        } else if (TEACHER.equals(userType)) {
            teacherDao.updateColByOneCondition(ArrayUtil.mapToUpdateArr(ReflectUtil.getObjectFieldMap(new Teacher()), map, condition));
            return Response.OK;
        } else {
            return Response.ERROR;
        }
